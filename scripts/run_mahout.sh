...
mahout clusterdump -i data_extractor/kmeans/clusters-*-final -o data_extractor/clusterdump -d data_extractor/seq_dir_sparse/dictionary.file-0 -dt sequencefile --evaluate -dm org.apache.mahout.common.distance.CosineDistanceMeasure --pointsDir data_extractor/kmeans/clusteredPoints
